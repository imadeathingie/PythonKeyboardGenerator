...
// move the whole thing 10mm up so the bottom of the switch is at z=0. this is just 
// for ease of use when dropping into a keyboard model.

// Keycaps with a stem at [0,0,0]need to be translated [0,0,7] (i.e. 10 - 3).

// module keycap(){
//     translate([0,0,7])
//         //translate([0,0,5])cube([10,10,10], center=true);
//         dsa_row(3) legend("Q", size=6) key();
// }
